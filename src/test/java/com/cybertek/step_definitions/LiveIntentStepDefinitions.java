...
import com.cybertek.pages.LiveIntentPage;
...
public class LiveIntentStepDefinitions {
    ...
    @Then("user should be able to navigate to free page")
    public void user_should_be_able_to_navigate_to_free_page() {

        Assert.assertTrue(Driver.getDriver().getCurrentUrl().contains("free-evaluation"));

    }

    @Then("user should be able to verify CONTACT US button presence in free page")
    public void user_should_be_able_to_verify_CONTACT_US_button_presence_in_free_page() {
